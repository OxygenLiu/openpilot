...
class SpeedLimitMiddleware:
  ...
  def update(self):
    ...
    confirmed_param = self.params.get("SpeedLimitConfirmed", encoding='utf-8')
    confirmed_value_param = self.params.get("SpeedLimitValue", encoding='utf-8')
    ...
    # Auto-confirm: if a higher-confidence source now agrees with current value
    # (e.g., OSM data arrives matching previous YOLO detection)
    # This is handled implicitly since the value doesn't change
