...
class DesireHelper:
  def __init__(self):
    ...
    # Consecutive lane change support: only discrete steering button, not gas pedal.
    # Gas pedal is continuous and release/re-press during normal driving could
    # accidentally trigger consecutive lane changes.
