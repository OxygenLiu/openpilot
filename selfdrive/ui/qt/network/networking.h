...
private:
  ...
  WifiUI* wifiWidget;
  QTimer* connectivityCheckTimer = nullptr;
  bool connectivityCheckPending = false;

  void showEvent(QShowEvent* event) override;
  void hideEvent(QHideEvent* event) override;

signals:
  void connectivityChanged(bool connected);  // GitHub connectivity status for sidebar

public slots:
  void refresh();
  void checkConnectivity();  // Check GitHub connectivity for sidebar CONNECT metric
