...
protected:
  ...
  bool onroad, recording_audio, flag_pressed, settings_pressed, mic_indicator_pressed, bmw_diagnostic_pressed;
  ...
  QString net_type;
  int net_strength = 0;
  bool internet_connected = false;  // GitHub connectivity status
