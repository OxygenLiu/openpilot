...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DccCalibrationMode", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, BOOL}},
    ...
    {"ExperimentalModeSpeed", {PERSISTENT, INT}},
    ...
    {"LaneCenteringCorrection", {PERSISTENT, BOOL, "0"}},
    ...
    {"MapdCurveTargetLatAccel", {PERSISTENT, INT}},
